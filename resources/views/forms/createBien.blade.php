...
<form method="post" action="/bailleur/bien/save">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <input id="addresse" type="text" class="form-control{{ $errors->has('addresse') ? ' is-invalid' : '' }}" name="addresse" value="{{ old('addresse') }}" required autofocus>
    ...
    <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="cp" type="postal-code" class="form-control{{ $errors->has('cp') ? ' is-invalid' : '' }}" name="cp" value="{{ old('cp') }}" required autofocus>
        ...
        <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="surface" type="number" class="form-control{{ $errors->has('surface') ? ' is-invalid' : '' }}" name="surface" min="1" step="0.01" placeholder='m²' value="{{ old('surface') }}"required autofocus>
        ...
        <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="room" type="number" class="form-control{{ $errors->has('room') ? ' is-invalid' : '' }}" name="room" min="1" step="1" value="{{ old('room') }}" required autofocus>
